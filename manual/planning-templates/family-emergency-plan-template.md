...
**Status:** Ready to use
**Version:** 1.0
**Purpose:** Document roles, responsibilities, and procedures for family members during emergencies
**Frequency:** Review monthly, update quarterly, drill bi-monthly
**Retention:** Current version plus all previous versions
...
Primary Decision Maker: ____________________________________
Secondary Decision Maker: __________________________________
...
Emergency Code Word: _______________________________________
"All Clear" Code: _________________________________________
"Need Help" Code: _________________________________________

Rally Point Communications:
If separated, check in every _______ hours
Primary contact method: ____________________________________
Backup contact method: _____________________________________
Message drop location: _____________________________________

External Communications:
Trusted Contact #1: _________________ Ph: _________________
Relationship: _____________ Location: _____________________

Trusted Contact #2: _________________ Ph: _________________
Relationship: _____________ Location: _____________________

Emergency Services: ________________________________________
Embassy/Consulate: _________________________________________
...
How to get there: _________________________________________
If closed/compromised, go to: _____________________________
Time limit to wait: _______________________________________
...
Marine Rally Point (if applicable):
Marina/Anchorage: _________________________________________
Coordinates: ______________________________________________
VHF Channel: ______________________________________________
Backup location: __________________________________________

Evacuation Routes:
Route A: ___________________________________________________
___________________________________________________________
Route B: ___________________________________________________
___________________________________________________________
Route C (Marine): _________________________________________
___________________________________________________________
...
CLIMATE/WEATHER EMERGENCY SCENARIO
Person | Primary Role | Secondary Role | Special Tasks
_____________________________________________________________
       |              |                |
       |              |                |
...
Special Medical Needs: _____________________________________
Behavioral Considerations: _________________________________
Education Materials: _______________________________________
Assigned Buddy: ___________________________________________

Emergency Explanation (age-appropriate):
___________________________________________________________
___________________________________________________________
...
Vet Contact: ______________________________________________
Pet Medications: __________________________________________
Food Supply: ______________________________________________
...
Bank Accounts:
Bank: _____________ Account: _______ Contact: _____________
Bank: _____________ Account: _______ Contact: _____________

Credit Cards:
Card: _____________ Number: ******__ Contact: _____________
Card: _____________ Number: ******** Contact: _____________

Investment/Retirement:
Account: __________ Provider: _______ Contact: ____________
...
Drill Schedule:
Communication Drill: Monthly on: ___________________________
Rally Point Drill: Quarterly on: __________________________
Full Evacuation Drill: Bi-annually on: ____________________
Scenario Drill: Monthly, rotating scenarios

Last Drill Conducted: _____________________________________
...
Next Scheduled Drill: _____________________________________
Type: _____________________________________________________
...
Mobility Aids: ____________________________________________
Care Plan: ________________________________________________

Family Members with Disabilities:
Name: _____________ Disability: ___________________________
Required Equipment: ________________________________________
Evacuation Assistance: _____________________________________
Medication Schedule: _______________________________________

Pregnant/Nursing Members:
Name: _____________ Due Date/Age of Baby: _________________
Special Supplies: _________________________________________
Medical Provider: _________________________________________
...
1. **Initial Planning Session:**
   - Involve all family members age-appropriately
   - Discuss realistic scenarios without causing panic
   - Assign roles based on capabilities
   - Set clear expectations

2. **Scenario Prioritization:**
   - Identify most likely scenarios for your location
   - Develop detailed plans for top 3 scenarios
   - Create general framework for others

3. **Role Assignment Principles:**
   - Match tasks to abilities
   - Provide backup for every critical role
   - Give everyone meaningful responsibilities
   - Consider physical and emotional capabilities

### Communication Protocols

**Internal Communications:**

- Establish clear code words that won't alarm others
- Practice using backup communication methods
- Set regular check-in times during separations
- Create communication cascade (who contacts whom)

**External Communications:**

- Designate single point of contact for extended family
- Establish "I'm okay" check-in system
- Plan for communication blackouts
- Include international calling codes

### Children and Emergency Planning

**Age-Appropriate Involvement:**

- Ages 3-6: Basic safety concepts, staying with adults
- Ages 7-11: Rally points, emergency contacts, simple tasks
- Ages 12-17: More complex roles, buddy system leadership
- Ages 18+: Full participation in planning and execution

**Reducing Anxiety:**

- Frame as "adventure planning"
- Focus on preparation as empowerment
- Practice through games and activities
- Celebrate successful drills

### Evacuation Decision Matrix

| Threat Level | Time Available | Action |
|--------------|---------------|--------|
| Immediate | < 1 hour | Go-bags only, primary route |
| Urgent | 1-6 hours | Planned supplies, check routes |
| Planned | 6-24 hours | Full preparation, optimal timing |
| Precautionary | > 24 hours | Staged departure, monitor situation |
...
- Encrypted storage
- Cloud backup
- USB drives in safe locations
- Password protection

### Training Priorities

**Essential Skills (All Adults):**

1. Basic first aid and CPR
2. Fire extinguisher use
3. Emergency communication methods
4. Basic navigation (map and compass)
5. Water procurement and purification

**Valuable Skills (At Least One Adult):**

1. Advanced first aid
2. Radio operation (VHF/SSB/Ham)
3. Basic mechanical repairs
4. Defensive driving
5. Small boat operation
...
**Quarterly Rally Point Drill:**

- Practice routes to rally points
- Time the journey
- Identify obstacles
- Test alternative routes

**Bi-Annual Full Evacuation:**

- Complete go-bag deployment
- Vehicle/vessel loading
- Document gathering
- Timed execution
...
- Reassign roles based on changes
- Update training requirements
- Refresh all supplies

### Integration with Other Plans

- **P.A.C.E. Planning:** Family plan supports Primary option
- **Threat Assessment:** Triggers activation criteria
- **Inventory Tracking:** Ensures family supplies ready
- **Medical Records:** Quick access to health information
- **Passage Planning:** Family roles during voyages
...
- Predetermined reunion plans
- Communication schedules
- Resource allocation

**Medical Emergencies During Crisis:**

- Triage decision tree
- Evacuation vs. shelter
- Medical professional contacts
- Medication rationing plans

**Security Concerns:**

- Home/vessel defense plans
- Avoiding confrontation strategies
- Law enforcement contacts
- Safe word for duress
