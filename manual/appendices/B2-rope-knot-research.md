...
- 7:1 scope: 25 x 7 = 175 ft rode needed
- 10:1 scope: 25 x 10 = 250 ft rode needed
...
2. **What's the expected load?**
   - Calculate: Required Working Load x Safety Factor = Minimum Breaking Strength
