...
Understanding how scenarios differ helps prioritize preparations and responses:
...
| **Primary Maritime Threat** | Piracy (desperate fishermen), supply scarcity | Violence, looting, confiscation, refugees boarding | Intensifying hurricanes, fisheries collapse, sea level rise | Naval operations, mines, confiscation, forced conscription | Port closures, quarantine enforcement, crew infection |
| **Critical Systems (Priority)** | Food (fishing), water, defense | Defense, medical (trauma), shelter | Water (desalination), food (fishing as species migrate), energy (hurricanes intensifying) | Defense, water, food, shelter, medical | Medical, water, food (extended isolation) |
...
**Slowest-developing threat (most planning time):**

1. **Climate Collapse** - Decades of warning; allows **gradual, strategic migration**

**Most unpredictable:**

1. **Civil Unrest** - Rapid escalation; hard to time departure
2. **Pandemic** - Mutation, transmission, severity uncertain until outbreak underway

**Longest duration:**

1. **Climate Collapse** - Centuries; no recovery in our lifetime
2. **Economic Collapse** - Depressions last 3-12 years (Great Depression: 12 years)
...
**If Economic Collapse + Civil Unrest:**

- Priority: Treat as **civil unrest** (violence is immediate threat; economic secondary)
- Depart based on violence indicators, not economic indicators alone
- Destination: Remote location + economic stability (not just stable currency)

**If Climate Collapse + Economic:**

- Priority: Depends on timing. Immediate weather threat (cyclone) > economic threat
- Long-term: Climate factors dominate destination selection (high-latitude refuge over dollarized tropical economy)

**If Pandemic + Economic:**

- Priority: Treat as **pandemic** (isolation paramount to avoid infection)
- Depart to remote location; avoid all ports (even in stable economies if pandemic active)
- Economic supplies secondary to medical isolation

**If War + Any Other:**

- Priority: **War** (kinetic threats take precedence)
- Depart to neutral zone immediately; other scenario considerations become secondary

**General Rule:** Immediate kinetic threats (war, violence, acute disease) take priority over chronic threats (economic instability, climate change). However, chronic threats require longer-term strategic planning that acute threats may disrupt.
